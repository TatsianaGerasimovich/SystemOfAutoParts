...
<form method="post" action="Controller" id="ENTER_INVOICE">
    <input type="hidden" name="command" value="ENTER_NEW_ITEMS"/>
    ...
    <div id="u20" class="ax_text_field">
        <input name="numberOfAutoPartsItems" pattern="[0-9]+" id="u20_input" type="text" value=""required/>
    </div>
    ...
    <div id="u23" class="ax_text_field">
        <input name="dateOfInvoice" id="u23_input" type="date" value="" required/>
    </div>
    ...
    <div id="u26" class="ax_html_button">
        <input id="u26_input" type="button" value="Добавить" onclick="submitForm('ENTER_INVOICE')"/>
    </div>
