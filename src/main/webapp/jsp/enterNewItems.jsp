...
<form method="post" action="Controller">
    <input type="hidden" name="command" value="ENTER_NEW_ITEMS" />
    <input type="hidden" name="typeOfEnterNewAutoParts" value="NEWAUTOPART" />
...
<div id="u29" class="ax_h2">
    ...
    <div id="u30" class="text">
        <p><span>Добавить новую</span></p><p><span> запчасть:</span></p>
    </div>
</div>
...
<form method="post" action="Controller">
    <input type="hidden" name="command" value="ENTER_NEW_ITEMS" />
    <input type="hidden" name="typeOfEnterNewAutoParts" value="ENTER_BY_KEYBOARD" />
...
<div id="u42" class="ax_text_field">
    <input id="u42_input" type="text" value="" disabled/>
</div>
...
<div id="u45" class="ax_text_field">
    <input id="u45_input" type="text" value="" disabled/>
</div>
...
<div id="u48" class="ax_text_field">
    <input id="u48_input" type="text" value="" disabled/>
</div>
...
<div id="u50" class="ax_paragraph">
    ...
    <div id="u51" class="text">
        <p><span>Number of brands which</span></p><p><span>it is suitable</span></p>
    </div>
</div>

<div id="u52" class="ax_text_field">
    <input id="u52_input" type="text" value="" disabled/>
</div>
...
<div id="u55" class="ax_paragraph">
    <img id="u55_img" class="img " src="jsp/accessories/resources/images/transparent.gif"/>

    <div id="u56" class="text">
        <p><span>Identification</span></p><p><span>number car brand</span><span>:</span></p>
    </div>
</div>

    <div id="u61" class="ax_droplist">
     <select name="idOfCarBrand" id="u61_input">
...
<div id="u57" class="ax_paragraph">
    <img id="u57_img" class="img " src="jsp/accessories/resources/images/transparent.gif"/>

    <div id="u58" class="text">
        <p><span>Identification</span></p><p><span>number car model</span><span>:</span></p>
    </div>
</div>

<div id="u59" class="ax_html_button">
    <input id="u59_input" type="submit" value="Добавить"/>
</div>

<div id="u62" class="ax_list_box">
    <select id="u62_input" size="2" disabled>
    </select>
</div>
</form>
</div>
